<template>
  <div class="image-editor-page">
              ...
              <div class="inline-history-section" id="inlineHistorySection">
                  ...
                  <div class="inline-history-content" id="inlineHistoryContent">
                      <div class="inline-history-grid" id="inlineHistoryGrid">
                          <p class="inline-history-empty">No generation history yet. Create your first image!</p>
                      </div>
      ...
      <!-- Edit History Prompt Modal -->
      <div class="edit-prompt-modal-overlay" id="editPromptModalOverlay">
...
// Legacy behavior initializes via `frontend/src/pages/image/main.ts`.
</script>
